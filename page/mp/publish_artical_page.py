...
class PubAriProxy:
    ...
    # 发布文章的业务方法
    def text_pub_aritcal(self, title, context, channel_name):
        # 2.输入标题
        self.pub_ari_handle.input_ari_title(title)
        # 3.输入内容
        self.pub_ari_handle.input_ari_context(context)
        # 4.选择封面
        self.pub_ari_handle.check__ari_cover()
        # 5.选择频道
